      ...
      <div className="relative flex items-center gap-3">
        <div className={`relative flex-1 group transition-all duration-300 ${isFocused ? 'scale-[1.01]' : ''}`}>
          ...
          <div className="relative">
            <Search className={`absolute left-5 top-1/2 transform -translate-y-1/2 w-5 h-5 transition-colors duration-200 ${isFocused ? 'text-[var(--accent-cyan)]' : 'text-[var(--text-muted)]'}`} />
              <input
                ...
                className={`
                  w-full pl-14 pr-14 py-3.5 bg-[#0d0d14] border-2 rounded-2xl 
          ...
          <button
            ...
            className={`
              hidden sm:flex items-center gap-3 px-5 py-3.5 rounded-2xl border-2 font-mono font-bold text-xs uppercase tracking-widest transition-all duration-300
              ${showFilters 
          ...
          <button
            ...
            className="sm:hidden p-3.5 bg-[#0d0d14] border-2 border-white/5 rounded-2xl text-[var(--text-secondary)] relative active:scale-95 transition-transform"
          >
        ...
        <AnimatePresence>
          {showFilters && (
            ...
            >
              <div className="mt-4 p-6 bg-[#0d0d14]/50 backdrop-blur-xl border-2 border-white/5 rounded-2xl relative overflow-hidden">
                ...
                <div className="relative grid grid-cols-3 gap-6">
                  <div className="space-y-3">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white/5 border border-white/5 rounded-xl text-[var(--text-primary)] outline-none focus:border-[var(--accent-blue)]/50 transition-all cursor-pointer appearance-none"
                    >
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white/5 border border-white/5 rounded-xl text-[var(--text-primary)] outline-none focus:border-[var(--accent-blue)]/50 transition-all cursor-pointer"
                    />
                  </div>
                </div>
          ...
          {showFilters && (
            <div className="sm:hidden fixed inset-0 z-[100] flex flex-col justify-end">
              ...
              <motion.div 
                ...
                className="relative bg-[#0a0a0f] border-t border-white/10 rounded-t-3xl p-6 pb-10 shadow-[0_-20px_50px_rgba(0,0,0,0.8)]"
              >
                <div className="w-12 h-1.5 bg-white/10 rounded-full mx-auto mb-6" />
                
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-black text-white uppercase tracking-tighter">Analysis Filters</h3>
                  <button 
                    onClick={handleReset}
                ...
                <div className="space-y-6 max-h-[60vh] overflow-y-auto no-scrollbar pb-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      value={filters.date || ''}
                      onChange={(e) => handleFilterChange('date', e.target.value)}
                      className="w-full px-6 py-3.5 bg-white/5 border-2 border-white/5 rounded-2xl text-[var(--text-primary)] outline-none focus:border-[var(--accent-blue)]/50 transition-all"
                    />
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full mt-10 py-4 bg-gradient-to-r from-[var(--accent-blue)] to-[var(--accent-purple)] text-white font-mono font-bold uppercase tracking-[0.2em] rounded-2xl shadow-2xl shadow-blue-500/30 active:scale-[0.98] transition-transform"
                >
                  Apply Analysis
                </button>
              </motion.div>
